...
- [Resolve "Move app API endpoint to core package"](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/d222354f4a56d2b65d78419d21bff67a87ce6cdb) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2516))
- [Add processing refactor to use temporal workflows. Disabled by default via feature flag.](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/d3f8b4d55eec4f0ce0c3ef61d4e06a1a7b65bc43) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2511))
- [Allow custom footer links on home page](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/eec52013d8240801e3d8ae72e9e156d7a4334a78) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2514))
...
- [Added support for multiple dimensionless units in the GUI unit system, added...](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/7865dfeb2ee7c060da80f118f46f9e0cac40f517) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2500))
...
- [Added support for using JMESPath map function with expression reference when...](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/d67188fd2eecf3c3a1c3baadfe384e399895957d) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2463))
- [Extend ref format in gui](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/d60d88bf00ce29fb5b315149a6fa1157366f3923) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2462))

### Changed (5 changes)

- [Upgrade dompurify to v3.2.6](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/54a3cc7db9ea3f09c26faeecf2567b627984a287) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2527))
- [Fix relatitve path](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/a8b2df5e30541ebef404d17a29f5d5c274a6d120) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2440))
- [Assign entry_type only when undefined](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/4d219bc561c5cdead72d7437c6983bd16158d61f) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2497))
- [Remove mkdocs code from nomad-FAIR](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/afe699a92c2c85806e793b89c0b0084aa07581cc) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2461))
...
- [Resolve "PubChem API calls fail after change to their API"](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/4315953e275cadf7811e3cf294a6a8e390ff53d2) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2515))
- [Fix mappper unit](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/87923f914dc5c4b595a7b2aff9b04be9fecabb0d) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2507))
...
- [Changed SampleHistoryCard query to use v1](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/e835c7fbbbf7264825e69cb1f90fc343b5315c42) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2477))
- [Resolve "quantity description in gui for special quantities"](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/4ab7fefa8ab1315e39389f2d14bef3f12f8fce54) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2450))
...
- [Resolve "Fixing NorthURL button opens default page if a tab is already opened"](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/commit/97895560309812b55e96dd475f0c51805ac1e2f7) ([merge request](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-FAIR/-/merge_requests/2460))
