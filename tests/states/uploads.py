...
def _build_example_data(
    ...
    """
    get_user = user_management.user_management.get_user
...
def archive_browser_test():
    infrastructure.setup()
    main_author = user_management.user_management.get_user(username='test').user_id
    coauthors = [user_management.user_management.get_user(username='scooper').user_id]
    reviewers = [user_management.user_management.get_user(username='ttester').user_id]
    upload = Upload(
