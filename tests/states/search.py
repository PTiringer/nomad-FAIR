...
method_dft_exciting = {
    'simulation': {
        ...
        'dft': {'xc_functional_names': ['LDA_X_PZ', 'LDA_C_PZ']},
    }
}
method_eels = {'method_name': 'EELS'}
properties_solar_cell = {
    ...
    'electronic': {
        'band_structure_electronic': [{'band_gap': [{'value': 2.5634826144e-19}]}]
    },
    'optoelectronic': {
        'solar_cell': {
            'efficiency': 15.9,
...
eln_catalysis = {'sections': ['CatalystSample'], 'names': ['MoVOx sample']}
...
def search():
    ...
    main_author = user_management.user_management.get_user(username='test')
    ...
    data.create_entry(
        ...
        results={'material': material_h2o, 'method': method_dft_vasp, 'properties': {}},
    ...
    data.create_entry(
        ...
        entry_id=create_uuid(),
        mainfile='upload/archive.json',
        results={'material': material_mof, 'method': method_dft_vasp, 'properties': {}},
    )
...
def histograms():
    ...
    for i in range(1, 5):
        ...
        data.create_entry(
            ...
            entry_id=create_uuid(),
            mainfile='upload/archive.json',
            results={'material': {'elements': ['H']}, 'method': {}, 'properties': {}},
        )
