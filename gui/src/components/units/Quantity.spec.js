...
test.each([
  ...
  ['explicit delta-delta (single)', 'delta_celsius', 'delta_celsius', 1, 1],
  ['explicit delta-regular (single, with denormalization)', 'delta_K', 'celsius', 1, 1],
  ['explicit delta-regular (single, without denormalization)', 'delta_celsius', 'K', 1, 1],
  ['explicit regular-delta (single, with denormalization)', 'K', 'delta_celsius', 1, 1],
  ['explicit regular-delta (single, without denormalization)', 'celsius', 'delta_K', 1, 1],
  ['explicit delta-delta (multiple)', 'delta_celsius / delta_celsius', 'delta_K / delta_K', 1, 1],
